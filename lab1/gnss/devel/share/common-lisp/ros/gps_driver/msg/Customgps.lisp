...
(cl:defmethod LatitudeDir-val ((m <Customgps>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gps_driver-msg:LatitudeDir-val is deprecated.  Use gps_driver-msg:LatitudeDir instead.")
  (LatitudeDir m))

(cl:ensure-generic-function 'LongitudeDir-val :lambda-list '(m))
(cl:defmethod LongitudeDir-val ((m <Customgps>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gps_driver-msg:LongitudeDir-val is deprecated.  Use gps_driver-msg:LongitudeDir instead.")
  (LongitudeDir m))
