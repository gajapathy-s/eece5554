...
class Customgps {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('LatitudeDir')) {
        this.LatitudeDir = initObj.LatitudeDir
      }
      else {
        this.LatitudeDir = '';
      }
      if (initObj.hasOwnProperty('LongitudeDir')) {
        this.LongitudeDir = initObj.LongitudeDir
      }
      else {
        this.LongitudeDir = '';
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [LatitudeDir]
    bufferOffset = _serializer.string(obj.LatitudeDir, buffer, bufferOffset);
    // Serialize message field [LongitudeDir]
    bufferOffset = _serializer.string(obj.LongitudeDir, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [LatitudeDir]
    data.LatitudeDir = _deserializer.string(buffer, bufferOffset);
    // Deserialize message field [LongitudeDir]
    data.LongitudeDir = _deserializer.string(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    ...
    length += _getByteLength(object.LatitudeDir);
    length += _getByteLength(object.LongitudeDir);
  ...
  static datatype() {
    ...
    return 'gnss/Customgps';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '40332f7c8344b73c529c712b74b53deb';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.LatitudeDir !== undefined) {
      resolved.LatitudeDir = msg.LatitudeDir;
    }
    else {
      resolved.LatitudeDir = ''
    }

    if (msg.LongitudeDir !== undefined) {
      resolved.LongitudeDir = msg.LongitudeDir;
    }
    else {
      resolved.LongitudeDir = ''
    }
